...
export default function TrendsSVG({color = "#80858B"}){
    return(
        <div className={svgStyle.header__SVG}>
            <svg className={svgStyle.svg} width="14" height="20" viewBox="0 0 14 20" fill={color} xmlns="http://www.w3.org/2000/svg">
